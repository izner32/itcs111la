...
function Nav() {
  return (
    <>
      <div className="px-32 py-4 sm:py-6 md:py-8 lg:py-10 lg:pb-12 text-center justify-between md:flex z-0">
        ...
        <ul className="text-[0.60rem] sm:text-sm flex justify-center z-20">
          <li className="mr-3">
